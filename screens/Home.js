...
export default class HomeScreen extends Component {
  ...
  getArticle = () => {
    const url = "http://2783-45-119-14-180.ngrok.io/get-article";
    axios
      .get(url)
      .then(response => {
  ...
  likedArticle = () => {
    const url = "http://2783-45-119-14-180.ngrok.io/liked-article";
    axios
      .post(url)
      .then(response => {
        this.getArticle();
  ...
  unlikedArticle = () => {
    const url = "http://2783-45-119-14-180.ngrok.io/unliked-article";
    axios
      .post(url)
      .then(response => {
        this.getArticle();
